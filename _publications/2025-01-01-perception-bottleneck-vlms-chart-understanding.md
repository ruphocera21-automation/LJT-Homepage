...
excerpt: 'First-author paper published on arXiv in 2025, with a GitHub code repository (Vision4Chart).'
date: 2025-01-01
venue: 'arXiv'
...
Junteng Liu is the first author of this paper. The paper is published on arXiv and has a GitHub code repository (Vision4Chart).
